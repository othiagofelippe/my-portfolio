    ...
    <section className="py-20 bg-background-primary dark:bg-background-primary-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          {/* Formação Acadêmica */}
          <div className="bg-background-secondary/20 dark:bg-background-tertiary rounded-2xl p-8 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 ease-out border border-border-primary/20">
            <h3 className="font-poppins text-xl text-text-headline dark:text-text-headline-dark mb-6 flex items-center gap-2">
